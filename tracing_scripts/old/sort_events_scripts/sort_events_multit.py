...
event_classes['hcTracer:async_memcpyslo_begin'] = btw.EventClass('hcTracer:async_memcpy_begin')
...
event_classes['hcTracer:async_memcpyslo_end'] = btw.EventClass('hcTracer:async_memcpy_end')
...
# event_classes['hcTracer:aql_packet_submitted'] = btw.EventClass('hcTracer:aql_packet_submitted')
# event_classes['hcTracer:aql_packet_submitted'].add_field(uint64_fd, 'packet_id')
# event_classes['hcTracer:aql_packet_submitted'].add_field(string_fd, 'packet_type')
# event_classes['hcTracer:aql_packet_submitted'].add_field(uint64_fd, 'agent_handle')
# event_classes['hcTracer:aql_packet_submitted'].add_field(uint64_fd, 'queue_id')
#
# event_classes['hcTracer:aql_kernel_dispatch_packet_submitted'] = btw.EventClass('hcTracer:aql_packet_submitted')
# event_classes['hcTracer:aql_kernel_dispatch_packet_submitted'].add_field(uint64_fd, 'packet_id')
# event_classes['hcTracer:aql_kernel_dispatch_packet_submitted'].add_field(uint64_fd, 'agent_handle')
# event_classes['hcTracer:aql_kernel_dispatch_packet_submitted'].add_field(uint64_fd, 'queue_id')
# event_classes['hcTracer:aql_kernel_dispatch_packet_submitted'].add_field(uint64_fd, 'kernel_object')
# event_classes['hcTracer:aql_kernel_dispatch_packet_submitted'].add_field(string_fd, 'kernel_name')
...
def worker1(all_events_, threadNB):
