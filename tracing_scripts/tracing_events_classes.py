...
event_classes['tensorflowTracer:gpu_bfc_chunks_stats'].add_field(int64_fd, 'total_wasted_bytes_in_use')
...
event_classes['tensorflowTracer:gpu_bfc_chunks_stats'].add_field(int64_fd, 'total_wasted_bytes')
...
event_classes['tensorflowTracer:cpu_bfc_chunks_stats'].add_field(int64_fd, 'total_wasted_bytes_in_use')
...
event_classes['tensorflowTracer:cpu_bfc_chunks_stats'].add_field(int64_fd, 'total_wasted_bytes')
