...
event_classes['hcTracer:kernel2_begin'] = btw.EventClass('hcTracer:kernel2_begin')
event_classes['hcTracer:kernel2_begin'].add_field(string_fd, 'cat')
event_classes['hcTracer:kernel2_begin'].add_field(uint64_fd, 'timestamp')
event_classes['hcTracer:kernel2_begin'].add_field(string_fd, 'name')
event_classes['hcTracer:kernel2_begin'].add_field(string_fd, 'tf_name')
event_classes['hcTracer:kernel2_begin'].add_field(string_fd, 'id')

event_classes['hcTracer:kernel2_end'] = btw.EventClass('hcTracer:kernel2_end')
event_classes['hcTracer:kernel2_end'].add_field(string_fd, 'cat')
event_classes['hcTracer:kernel2_end'].add_field(uint64_fd, 'timestamp')
event_classes['hcTracer:kernel2_end'].add_field(string_fd, 'name')
event_classes['hcTracer:kernel2_end'].add_field(string_fd, 'tf_name')
event_classes['hcTracer:kernel2_end'].add_field(string_fd, 'id')

event_classes['hcTracer:barrier2_begin'] = btw.EventClass('hcTracer:barrier2_begin')
event_classes['hcTracer:barrier2_begin'].add_field(string_fd, 'cat')
event_classes['hcTracer:barrier2_begin'].add_field(uint64_fd, 'timestamp')
event_classes['hcTracer:barrier2_begin'].add_field(string_fd, 'name')
event_classes['hcTracer:barrier2_begin'].add_field(string_fd, 'id')
event_classes['hcTracer:barrier2_end'] = btw.EventClass('hcTracer:barrier2_end')
event_classes['hcTracer:barrier2_end'].add_field(string_fd, 'cat')
event_classes['hcTracer:barrier2_end'].add_field(uint64_fd, 'timestamp')
event_classes['hcTracer:barrier2_end'].add_field(string_fd, 'name')
event_classes['hcTracer:barrier2_end'].add_field(string_fd, 'id')
event_classes['hcTracer:async_memcpy2_begin'] = btw.EventClass('hcTracer:async_memcpy2_begin')
event_classes['hcTracer:async_memcpy2_begin'].add_field(string_fd, 'cat')
event_classes['hcTracer:async_memcpy2_begin'].add_field(uint64_fd, 'timestamp')
event_classes['hcTracer:async_memcpy2_begin'].add_field(string_fd, 'name')
event_classes['hcTracer:async_memcpy2_begin'].add_field(int64_fd, 'size_bytes')
event_classes['hcTracer:async_memcpy2_begin'].add_field(float_fd, 'size_megabytes')
event_classes['hcTracer:async_memcpy2_begin'].add_field(float_fd, 'throughput')
event_classes['hcTracer:async_memcpy2_end'] = btw.EventClass('hcTracer:async_memcpy2_end')
event_classes['hcTracer:async_memcpy2_end'].add_field(string_fd, 'cat')
event_classes['hcTracer:async_memcpy2_end'].add_field(uint64_fd, 'timestamp')
event_classes['hcTracer:async_memcpy2_end'].add_field(string_fd, 'name')
event_classes['hcTracer:async_memcpy2_end'].add_field(int64_fd, 'size_bytes')
event_classes['hcTracer:async_memcpy2_end'].add_field(float_fd, 'size_megabytes')
event_classes['hcTracer:async_memcpy2_end'].add_field(float_fd, 'throughput')
event_classes['hcTracer:async_memcpyslo2_begin'] = btw.EventClass('hcTracer:async_memcpyslo2_begin')
event_classes['hcTracer:async_memcpyslo2_begin'].add_field(string_fd, 'cat')
event_classes['hcTracer:async_memcpyslo2_begin'].add_field(uint64_fd, 'timestamp')
event_classes['hcTracer:async_memcpyslo2_begin'].add_field(string_fd, 'name')
event_classes['hcTracer:async_memcpyslo2_begin'].add_field(int64_fd, 'size_bytes')
event_classes['hcTracer:async_memcpyslo2_begin'].add_field(float_fd, 'size_megabytes')
event_classes['hcTracer:async_memcpyslo2_begin'].add_field(float_fd, 'throughput')
event_classes['hcTracer:async_memcpyslo2_end'] = btw.EventClass('hcTracer:async_memcpyslo2_end')
event_classes['hcTracer:async_memcpyslo2_end'].add_field(string_fd, 'cat')
event_classes['hcTracer:async_memcpyslo2_end'].add_field(uint64_fd, 'timestamp')
event_classes['hcTracer:async_memcpyslo2_end'].add_field(string_fd, 'name')
event_classes['hcTracer:async_memcpyslo2_end'].add_field(int64_fd, 'size_bytes')
event_classes['hcTracer:async_memcpyslo2_end'].add_field(float_fd, 'size_megabytes')
event_classes['hcTracer:async_memcpyslo2_end'].add_field(float_fd, 'throughput')
