...
def train():
  ...
  tf.contrib.tfprof.tfprof_logger.write_op_log(sess.graph, output_dir, op_log=None)
  # end tfprof
  ...
  opts['output'] = 'timeline:outfile=traces'
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--log_dir',
      type=str,
      default='/home/pierre/Tensorboard/MNIST',
